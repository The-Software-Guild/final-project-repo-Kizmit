...
public class ContestComboDetail {
    ...
    public ArrayList<Move> getUse_before() {
        return use_before;
    }

    public void setUse_before(ArrayList<Move> use_before) {
        this.use_before = use_before;
    }

    public ArrayList<Move> getUse_after() {
        return use_after;
    }

    public void setUse_after(ArrayList<Move> use_after) {
